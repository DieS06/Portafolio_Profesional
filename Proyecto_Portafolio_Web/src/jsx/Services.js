    ...
    return (
        <div className="services">
            ...
            <div className="btn-space">
                ...
                <button id='btn-Service' onClick = {GeneralistClick}> 3D Generalist </button>
                {showWork3D && (
                ...
                <div className="btn-Service">
                <button id='btn-Service' onClick = {ProgrammerClick}> Software Engineering </button>
                {showWorkProg && (
                <div className='showReel'>
                    {/* Work Showreel*/}
                </div>
                ...
                <div className="btn-Service">
                <button id='btn-Service' onClick = {DesignClick}> Design </button>
                {showWorkDesign && (
                <div className='showReel'>
                    {/* Work Showreel*/}
                </div>
